...
class Ui_banabiSiparisEkrani6(object):
    def setupUi(self, banabiSiparisEkrani6):

        banabiSiparisEkrani6.setObjectName("banabiSiparisEkrani6")
        banabiSiparisEkrani6.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani6)
        ...
        banabiSiparisEkrani6.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani6)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani6.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani6)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani6.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani6)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani6)

    def retranslateUi(self, banabiSiparisEkrani6):
        ...
        try:
            ...
            banabiSiparisEkrani6.setWindowTitle(_translate("banabiSiparisEkrani6", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani6", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani6", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani6", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani6", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani6", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani6", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani6", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani6", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani6", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani6", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani6", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani6", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani6", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani6", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani6", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani6.setWindowTitle(_translate("banabiSiparisEkrani6", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani6", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani6", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani6", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani6", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani6", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani6", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani6", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani6", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani6", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani6", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani6", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani6", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani6", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani6", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani6", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani6 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani6()
    ui.setupUi(banabiSiparisEkrani6)
    banabiSiparisEkrani6.show()
    sys.exit(app.exec_())
