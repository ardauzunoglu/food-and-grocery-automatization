...
class Ui_banabiSiparisEkrani4(object):
    def setupUi(self, banabiSiparisEkrani4):

        banabiSiparisEkrani4.setObjectName("banabiSiparisEkrani4")
        banabiSiparisEkrani4.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani4)
        ...
        banabiSiparisEkrani4.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani4)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani4.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani4)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani4.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani4)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani4)

    def retranslateUi(self, banabiSiparisEkrani4):
        ...
        try:
            ...
            banabiSiparisEkrani4.setWindowTitle(_translate("banabiSiparisEkrani4", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani4", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani4", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani4", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani4", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani4", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani4", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani4", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani4", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani4", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani4", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani4", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani4", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani4", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani4", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani4", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani4.setWindowTitle(_translate("banabiSiparisEkrani4", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani4", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani4", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani4", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani4", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani4", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani4", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani4", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani4", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani4", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani4", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani4", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani4", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani4", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani4", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani4", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani4 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani4()
    ui.setupUi(banabiSiparisEkrani4)
    banabiSiparisEkrani4.show()
    sys.exit(app.exec_())
