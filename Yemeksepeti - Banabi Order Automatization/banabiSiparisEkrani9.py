...
class Ui_banabiSiparisEkrani9(object):
    def setupUi(self, banabiSiparisEkrani9):

        banabiSiparisEkrani9.setObjectName("banabiSiparisEkrani9")
        banabiSiparisEkrani9.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani9)
        ...
        banabiSiparisEkrani9.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani9)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani9.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani9)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani9.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani9)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani9)

    def retranslateUi(self, banabiSiparisEkrani9):
        ...
        try:
            ...
            banabiSiparisEkrani9.setWindowTitle(_translate("banabiSiparisEkrani9", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani9", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani9", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani9", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani9", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani9", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani9", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani9", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani9", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani9", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani9", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani9", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani9", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani9", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani9", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani9", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani9.setWindowTitle(_translate("banabiSiparisEkrani9", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani9", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani9", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani9", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani9", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani9", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani9", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani9", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani9", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani9", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani9", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani9", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani9", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani9", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani9", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani9", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani9 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani9()
    ui.setupUi(banabiSiparisEkrani9)
    banabiSiparisEkrani9.show()
    sys.exit(app.exec_())
