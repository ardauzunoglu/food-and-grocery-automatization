...
class Ui_banabiSiparisEkrani7(object):
    def setupUi(self, banabiSiparisEkrani7):

        banabiSiparisEkrani7.setObjectName("banabiSiparisEkrani7")
        banabiSiparisEkrani7.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani7)
        ...
        banabiSiparisEkrani7.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani7)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani7.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani7)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani7.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani7)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani7)

    def retranslateUi(self, banabiSiparisEkrani7):
        ...
        try:
            ...
            banabiSiparisEkrani7.setWindowTitle(_translate("banabiSiparisEkrani7", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani7", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani7", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani7", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani7", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani7", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani7", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani7", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani7", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani7", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani7", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani7", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani7", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani7", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani7", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani7", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani7.setWindowTitle(_translate("banabiSiparisEkrani7", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani7", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani7", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani7", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani7", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani7", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani7", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani7", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani7", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani7", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani7", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani7", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani7", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani7", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani7", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani7", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani7 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani7()
    ui.setupUi(banabiSiparisEkrani7)
    banabiSiparisEkrani7.show()
    sys.exit(app.exec_())
