...
class Ui_banabiSiparisEkrani8(object):
    def setupUi(self, banabiSiparisEkrani8):

        banabiSiparisEkrani8.setObjectName("banabiSiparisEkrani8")
        banabiSiparisEkrani8.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani8)
        ...
        banabiSiparisEkrani8.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani8)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani8.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani8)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani8.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani8)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani8)

    def retranslateUi(self, banabiSiparisEkrani8):
        ...
        try:
            ...
            banabiSiparisEkrani8.setWindowTitle(_translate("banabiSiparisEkrani8", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani8", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani8", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani8", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani8", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani8", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani8", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani8", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani8", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani8", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani8", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani8", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani8", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani8", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani8", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani8", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani8.setWindowTitle(_translate("banabiSiparisEkrani8", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani8", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani8", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani8", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani8", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani8", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani8", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani8", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani8", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani8", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani8", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani8", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani8", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani8", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani8", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani8", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani8 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani8()
    ui.setupUi(banabiSiparisEkrani8)
    banabiSiparisEkrani8.show()
    sys.exit(app.exec_())
