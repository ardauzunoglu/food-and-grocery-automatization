...
class Ui_banabiSiparisEkrani2(object):
    def setupUi(self, banabiSiparisEkrani2):

        banabiSiparisEkrani2.setObjectName("banabiSiparisEkrani2")
        banabiSiparisEkrani2.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani2)
        ...
        banabiSiparisEkrani2.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani2)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani2.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani2)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani2.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani2)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani2)

    def retranslateUi(self, banabiSiparisEkrani2):
        ...
        try:
            ...
            banabiSiparisEkrani2.setWindowTitle(_translate("banabiSiparisEkrani2", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani2", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani2", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani2", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani2", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani2", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani2", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani2", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani2", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani2", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani2", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani2", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani2", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani2", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani2", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani2", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani2.setWindowTitle(_translate("banabiSiparisEkrani2", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani2", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani2", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani2", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani2", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani2", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani2", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani2", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani2", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani2", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani2", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani2", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani2", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani2", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani2", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani2", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani2 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani2()
    ui.setupUi(banabiSiparisEkrani2)
    banabiSiparisEkrani2.show()
    sys.exit(app.exec_())
