...
class Ui_banabiSiparisEkrani1(object):
    def setupUi(self, banabiSiparisEkrani1):

        banabiSiparisEkrani1.setObjectName("banabiSiparisEkrani1")
        banabiSiparisEkrani1.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani1)
        ...
        banabiSiparisEkrani1.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani1)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani1.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani1)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani1.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani1)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani1)

    def retranslateUi(self, banabiSiparisEkrani1):
        ...
        try:
            ...
            banabiSiparisEkrani1.setWindowTitle(_translate("banabiSiparisEkrani1", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani1", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani1", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani1", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani1", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani1", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani1", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani1", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani1", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani1", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani1", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani1", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani1", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani1", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani1", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani1", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani1.setWindowTitle(_translate("banabiSiparisEkrani1", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani1", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani1", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani1", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani1", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani1", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani1", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani1", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani1", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani1", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani1", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani1", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani1", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani1", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani1", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani1", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani1 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani1()
    ui.setupUi(banabiSiparisEkrani1)
    banabiSiparisEkrani1.show()
    sys.exit(app.exec_())
