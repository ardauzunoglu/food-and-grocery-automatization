...
class Ui_banabiSiparisEkrani3(object):
    def setupUi(self, banabiSiparisEkrani3):

        banabiSiparisEkrani3.setObjectName("banabiSiparisEkrani3")
        banabiSiparisEkrani3.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani3)
        ...
        banabiSiparisEkrani3.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani3)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani3.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani3)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani3.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani3)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani3)

    def retranslateUi(self, banabiSiparisEkrani3):
        ...
        try:
            ...
            banabiSiparisEkrani3.setWindowTitle(_translate("banabiSiparisEkrani3", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani3", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani3", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani3", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani3", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani3", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani3", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani3", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani3", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani3", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani3", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani3", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani3", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani3", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani3", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani3", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani3.setWindowTitle(_translate("banabiSiparisEkrani3", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani3", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani3", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani3", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani3", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani3", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani3", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani3", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani3", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani3", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani3", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani3", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani3", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani3", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani3", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani3", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani3 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani3()
    ui.setupUi(banabiSiparisEkrani3)
    banabiSiparisEkrani3.show()
    sys.exit(app.exec_())
