...
class Ui_banabiSiparisEkrani10(object):
    def setupUi(self, banabiSiparisEkrani10):

        banabiSiparisEkrani10.setObjectName("banabiSiparisEkrani10")
        banabiSiparisEkrani10.resize(500, 675)

        self.centralwidget = QtWidgets.QWidget(banabiSiparisEkrani10)
        ...
        banabiSiparisEkrani10.setCentralWidget(self.centralwidget)

        self.menubar = QtWidgets.QMenuBar(banabiSiparisEkrani10)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 500, 21))
        self.menubar.setObjectName("menubar")

        banabiSiparisEkrani10.setMenuBar(self.menubar)

        self.statusbar = QtWidgets.QStatusBar(banabiSiparisEkrani10)
        self.statusbar.setObjectName("statusbar")

        banabiSiparisEkrani10.setStatusBar(self.statusbar)

        self.retranslateUi(banabiSiparisEkrani10)
        QtCore.QMetaObject.connectSlotsByName(banabiSiparisEkrani10)

    def retranslateUi(self, banabiSiparisEkrani10):
        ...
        try:
            ...
            banabiSiparisEkrani10.setWindowTitle(_translate("banabiSiparisEkrani10", siparisAdi))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani10", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani10", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani10", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani10", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani10", "Birinci Parça Adet:  "+str(birinciParcaAdet)))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani10", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani10", "İkinci Parça Adet:  "+str(ikinciParcaAdet)))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani10", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani10", "Üçüncü Parça Adet:  "+str(ucuncuParcaAdet)))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani10", "Dördüncü Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani10", "Dördüncü Parça Adet:  "+str(dorduncuParcaAdet)))
            self.besinciParca.setText(_translate("banabiSiparisEkrani10", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani10", "Beşinci Parça Adet:  "+str(besinciParcaAdet)))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani10", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani10", "Sipariş Ver"))
            ...
            _translate = QtCore.QCoreApplication.translate
            banabiSiparisEkrani10.setWindowTitle(_translate("banabiSiparisEkrani10", "Boş Menü"))

            self.siparisAdi.setText(_translate("banabiSiparisEkrani10", "Sipariş Adı:  "+siparisAdi))
            self.kullaniciAdi.setText(_translate("banabiSiparisEkrani10", "Yemeksepeti Hesabı:  "+kullaniciAdi))
            self.sehir.setText(_translate("banabiSiparisEkrani10", "Şehir:  "+sehir))
            self.birinciParca.setText(_translate("banabiSiparisEkrani10", "Birinci Parça:  "+birinciParca))
            self.birinciParcaAdet.setText(_translate("banabiSiparisEkrani10", "Birinci Parça Adet:  "+birinciParcaAdet))
            self.ikinciParca.setText(_translate("banabiSiparisEkrani10", "İkinci Parça:  "+ikinciParca))
            self.ikinciParcaAdet.setText(_translate("banabiSiparisEkrani10", "İkinci Parça Adet:  "+ikinciParcaAdet))
            self.ucuncuParca.setText(_translate("banabiSiparisEkrani10", "Üçüncü Parça:  "+ucuncuParca))
            self.ucuncuParcaAdet.setText(_translate("banabiSiparisEkrani10", "Üçüncü Parça Adet:  "+ucuncuParcaAdet))
            self.dorduncuParca.setText(_translate("banabiSiparisEkrani10", "Dördün Parça:  "+dorduncuParca))
            self.dorduncuParcaAdet.setText(_translate("banabiSiparisEkrani10", "Dördüncü Parça Adet:  "+dorduncuParcaAdet))
            self.besinciParca.setText(_translate("banabiSiparisEkrani10", "Beşinci Parça:  "+besinciParca))
            self.besinciParcaAdet.setText(_translate("banabiSiparisEkrani10", "Beşinci Parça Adet:  "+besinciParcaAdet))
            self.siparisiSil.setText(_translate("banabiSiparisEkrani10", "Siparişi Sil"))
            self.siparisVer.setText(_translate("banabiSiparisEkrani10", "Sipariş Ver"))
...
if __name__ == "__main__":
    ...
    banabiSiparisEkrani10 = QtWidgets.QMainWindow()
    ui = Ui_banabiSiparisEkrani10()
    ui.setupUi(banabiSiparisEkrani10)
    banabiSiparisEkrani10.show()
    sys.exit(app.exec_())
